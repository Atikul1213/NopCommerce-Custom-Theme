...
/// </summary>
public static class EuroQuipDefaults
{
    ...
    /// </summary>
    public const string IS_PICKUP_SETTINGS_KEY = "ShippingRateComputationMethod.FixedByWeightByTotal.IsPickUp.ShippingMethodId{0}";

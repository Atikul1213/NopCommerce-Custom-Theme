...
namespace NopStation.Plugin.Widgets.AddCrawlers.Factories
{
    public class CrawlerFactory : ICrawlerFactory
    {
        ...
        /// <summary>
        /// Prepare online guest customer search model
        /// </summary>
        /// <param name="searchModel">Online guest customer search model</param>
        /// <returns>
        /// A task that represents the asynchronous operation
        /// The task result contains the online guest customer search model
        /// </returns>
        ...
        /// <summary>
        /// Prepare paged online guest customer list model
        /// </summary>
        /// <param name="searchModel">Online guest customer search model</param>
        /// <returns>
        /// A task that represents the asynchronous operation
        /// The task result contains the online guest customer list model
        /// </returns>

...
namespace NopStation.Plugin.Widgets.AddCrawlers.Controllers
{
    public class WidgetsAddCrawlersController : NopStationAdminController
    {
        #region Fields
        ...
        public WidgetsAddCrawlersController(ILocalizationService localizationService,
        ...
        public async Task<IActionResult> Configure()
        {
            ...
            var crawlersSettings = await _settingService.LoadSettingAsync<AddCrawlerSettings>(storeScope);
        ...
        public virtual async Task<IActionResult> AddCrawler(int selectedId)
        {
            ...
            {
                await _logger.ErrorAsync(_localizationService.GetResourceAsync("Plugins.Widgets.AddCrawlers.LogError.AddFailed").Result, ex);
                return Json(new { result = false });
            }
        }
